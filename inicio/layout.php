        ...
        <nav class="navbar flex-nowrap p-0">
            <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
                ...
                <a class="navbar-brand navbar-brand-desktop" href="/">
                    <img class="side-nav-show-on-closed" src="public/img/logo-mini.png" alt="Graindashboard"
                        style="width: auto; height: 33px;">
                    <img class="side-nav-hide-on-closed" src="public/img/logo.png" alt="Graindashboard"
                        style="width: auto; height: 33px;">
                </a>
                ...
                <div class="d-flex align-items-center">
                        ...
                        <div id="notifications"
                            ...
                            <div class="card">
                                <div class="card-header d-flex align-items-center border-bottom py-3">
                                    ...
                                    <a class="link small ml-auto" href="#">Limpiar todo</a>
                                </div>
                                    ...
                                    <div class="list-group list-group-flush">
                                        <div class="list-group-item list-group-item-action">
                                            <div class="d-flex align-items-center text-nowrap mb-2">
                                                ...
                                                <h6 class="font-weight-semi-bold mb-0">Nueva Actualización</h6>
                                                <span class="list-group-item-date text-muted ml-auto">Ahora</span>
                                            </div>
                                            <p class="mb-0">
                                                numero de notificaciones <strong>#10000</strong> .
                                            </p>
                                        ...
                                        <div class="list-group-item list-group-item-action">
                                            ...
                                            <p class="mb-0">
                                                Numero de notificaciones <strong>#10001</strong> .
                                            </p>
                                            <a class="list-group-item-closer text-muted" href="#"><i
                                                    class="gd-close"></i></a>
                                        </div>
                    ...
                    <div class="dropdown mx-3 dropdown ml-2">
                        <a id="profileMenuInvoker" class="header-complex-invoker" href="#" aria-controls="profileMenu"
                            ...
                            <span class="d-none d-md-block">Edwin Escorcia</span>
                        ...
                        <ul id="profileMenu"
                            ...
                            <li class="unfold-item unfold-item-has-divider">
                                <a class="unfold-link d-flex align-items-center text-nowrap" href="login">
                                    <span class="unfold-item-icon mr-3">
    ...
    <main class="main">
        ...
        <aside id="sidebar" class="js-custom-scroll side-nav">
            <ul id="sideNav" class="side-nav-menu side-nav-menu-top-level mb-0">
                <!-- Title -->
                <li class="sidebar-heading h6">Inicio</li>
                <!-- End Title -->
                <!-- Dashboard -->
                ...
                <li class="side-nav-menu-item side-nav-has-menu">
                    <a class="side-nav-menu-link media align-items-center" href="#" data-target="#subUsers">
                        ...
                        <span class="side-nav-fadeout-on-closed media-body">Empleados</span>
                ...
                <li class="side-nav-menu-item side-nav-has-menu">
                    <a class="side-nav-menu-link media align-items-center" href="#" data-target="#subEquipos">
                        ...
                        <span class="side-nav-fadeout-on-closed media-body">Equipos</span>
                        <span class="side-nav-control-icon d-flex">
                            <i class="gd-angle-right side-nav-fadeout-on-closed"></i>
                        </span>
                        <span class="side-nav__indicator side-nav-fadeout-on-closed"></span>
                    ...
                    <!-- Users: subEquipos -->
                    <ul id="subEquipos" class="side-nav-menu side-nav-menu-second-level mb-0">
                        <li class="side-nav-menu-item">
                ...
                <li class="side-nav-menu-item side-nav-has-menu">
                    <a class="side-nav-menu-link media align-items-center" href="#" data-target="#subAsignacion">
                        ...
                        <span class="side-nav-fadeout-on-closed media-body">Asignacion</span>
                        <span class="side-nav-control-icon d-flex">
                            <i class="gd-angle-right side-nav-fadeout-on-closed"></i>
                        </span>
                        <span class="side-nav__indicator side-nav-fadeout-on-closed"></span>
                    ...
                    <ul id="subAsignacion" class="side-nav-menu side-nav-menu-second-level mb-0">
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" href="ver_asignacion">Ver Asignacion</a>
                        </li>
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" href="agregarasignacion">Agregar Asignacion</a>
                        </li>
                    </ul>
                ...
                <!-- <li class="side-nav-menu-item side-nav-has-menu">
                    <a class="side-nav-menu-link media align-items-center" href="#" data-target="#subPages">
                        ...
                        <span class="side-nav-fadeout-on-closed media-body">Autentificacion</span>
                        <span class="side-nav-control-icon d-flex">
                            <i class="gd-angle-right side-nav-fadeout-on-closed"></i>
                        </span>
                        <span class="side-nav__indicator side-nav-fadeout-on-closed"></span>
                    ...
                    <ul id="subPages" class="side-nav-menu side-nav-menu-second-level mb-0">
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" asp-area="" asp-controller="/" asp-action="">Login</a>
                        </li>
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" asp-area="" asp-controller="Autentificacion"
                                asp-action="Registro">Registrarse</a>
                        </li>
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" asp-area="" asp-controller="Autentificacion"
                                asp-action="Recuperar_clave">Forgot Password</a>
                        </li>
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" asp-area="" asp-controller="Autentificacion"
                                asp-action="Recuperar_clave2">Forgot Password 2</a>
                        </li>
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" asp-area="" asp-controller="Autentificacion"
                                asp-action="Verificacion_email">Email Verification</a>
                        </li>
                    </ul>
                ...
                <li class="side-nav-menu-item">
                    ...
                    <a class="side-nav-menu-link media align-items-center" href="settings">
                        <span class="side-nav-menu-icon d-flex mr-3">
                            <i class="gd-settings"></i>
                        </span>
                        <span class="side-nav-fadeout-on-closed media-body">Ajustes de Admin</span>
                    </a>
                </li>
                <!-- End Settings -->
                <!-- Static -->
                <li class="side-nav-menu-item">
                    <a class="side-nav-menu-link media align-items-center" href="static-non-auth">
                        <span class="side-nav-menu-icon d-flex mr-3">
                            <i class="gd-file"></i>
                        </span>
                        <span class="side-nav-fadeout-on-closed media-body">Pagina estatica</span>
                    </a>
                </li>
                <!-- End Static -->
        ...
        <div class="content">
            ...
            <div id="content" class="py-4 px-3 px-md-4">



                <?php
                // Aquí se cargará el contenido específico basado en la página
                if (isset($content)) {
                    echo $content;
                }
                ?>
            ...
            <footer class="small p-3 px-md-4 mt-auto">
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg text-center text-lg-right">
                        &copy; 2024 Inventarios. Todos los derechos reservados.
                    </div>
                </div>
            </footer>
            <!-- End Footer -->
...
<?php
 include 'equipos/ajustesequipos/modalajustesequipos.php';
