<div class="card mb-3 mb-md-4">
    ...
    <div class="card-body">
        ...
        <button id="btn-actualizar-varios-empleados" type="submit" class="btn btn-primary float-right"  data-toggle="modal" data-target="#modalactualizarvariosestadosempleados" disabled >Activar - inactivar</button>
        <!--  -->
