        ...
        <nav class="d-none d-md-block" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="#"> Tipos de Equipos</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Todos los Tipos de equipos</li>
            </ol>
        </nav>
        <!-- End Breadcrumb -->

        <button id="" type="submit" class="btn btn-primary float-right" data-toggle="modal" data-target="#modaltiposequipos">Crear tipos de equipos</button>

        <!--btn modal abrir guardar tipos  -->
        <!-- <div class="tab-pane fade p-4 show active" id="pills-result-1" role="tabpanel"
            aria-labelledby="pills-result-tab-1">
            <a class="btn btn-outline-primary" href="#" data-toggle="modal" data-target="#exampleModal">Launch demo
                modal</a>
        </div> -->
        <!--  -->
        <div class="mb-3 mb-md-4 d-flex justify-content-between">
            <div class="h3 mb-0">Tipos de equipos</div>
        </div>
